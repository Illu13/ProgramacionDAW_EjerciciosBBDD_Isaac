...
import com.jds.centroEducativo.controller.ControladorEstudiante;
import com.jds.centroEducativo.controller.ControladorProfesor;
import com.jds.centroEducativo.model.Estudiante;
...
//		gridBagLayout.rowWeights = new double[]{0.0, Double.MIN_VALUE};
	...
	public void cargarDatos(Profesor es) {
		...
		datosPersonales.setSexo(es.getIdSexo());
	...
	public Profesor obtenerDatos() {
		...
		prof.setApellido1(datosPersonales.getApellido());
		prof.setApellido2(datosPersonales.getSegundoApellido());
		...
		prof.setIdSexo(datosPersonales.getSexo().getId());

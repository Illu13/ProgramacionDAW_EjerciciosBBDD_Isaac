...
public class PanelDatosPersonales2 extends JPanel {
	...
	public PanelDatosPersonales2(MiTableModel mtm, JTable t) {
...
//		gridBagLayout.rowWeights = new double[]{Double.MIN_VALUE};
		...
		saveButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (estu.getId() != 0) {
					...
					ponerValoresObjetoInsertado(mtm, t, estu);
					setId(estu.getId());
				}
	...
	private void ponerValores(MiTableModel dtm, JTable t) {
	...
	private void ponerValoresObjetoInsertado(MiTableModel dtm, JTable t, Estudiante estu) {
	...
	private void ponerValoresPanel(MiTableModel dtm, JTable t) {
		int indiceFilaSel = t.getSelectedRow();
	...
	private void introducirColumna(JTable table) {
		Object[] dataList = {""};               
